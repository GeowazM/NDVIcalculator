...
#
# Created: Fri Jun 17 11:18:22 2016
...
class Ui_NDVIcalculatorDialogBase(object):
    ...
    def retranslateUi(self, NDVIcalculatorDialogBase):
        ...
        self.lineEdit_input.setText(_translate("NDVIcalculatorDialogBase", "Z:/Shared/data/vegas_2011.img", None))
        ...
        self.spinBox_nir.setSpecialValueText(_translate("NDVIcalculatorDialogBase", "4", None))
        self.label_nir.setText(_translate("NDVIcalculatorDialogBase", "NIR", None))
        self.spinBox_red.setSpecialValueText(_translate("NDVIcalculatorDialogBase", "3", None))
        ...
        self.spinBox_x.setSpecialValueText(_translate("NDVIcalculatorDialogBase", "5", None))
        self.label_x.setText(_translate("NDVIcalculatorDialogBase", "X", None))
        self.spinBox_y.setSpecialValueText(_translate("NDVIcalculatorDialogBase", "5", None))
        ...
        self.lineEdit_output.setText(_translate("NDVIcalculatorDialogBase", "Z:/Shared/data/vegas_2011NDVI.img", None))
        self.pushButton_output.setText(_translate("NDVIcalculatorDialogBase", "Open ...", None))
